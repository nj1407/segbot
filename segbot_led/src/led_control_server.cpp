...
/*          // Left Turn Circular Animation [One Set]
          ...
          //ROS_INFO("YOU ARE IN THE CORRECT METHOD.");
              ...
              while(!as_.isPreemptRequested() && !timeout && ros::ok())
              {
                ...
                feedback_.time_running = time_running;
                as_.publishFeedback(feedback_);
                int i = circular_u_end;
                
                leds.setRGB(i - 10, 0, 0, 75);
                /*int count = 0;
                while(count < 25)
                {
                  ...
                  leds.setRGB(back_left_beam_end, 0, 0, 20);
            ...
            case bwi_msgs::LEDAnimations::FORWARD:
            {
              ...
              while(!as_.isPreemptRequested() && !timeout && ros::ok())
              {
                ...
                feedback_.time_running = time_running;
                as_.publishFeedback(feedback_);
                int j = circular_u_end;
                int k = circular_u_start - 1;
                int l = top_of_u_start - 1;
                ...
                for (int i = 1; i <= 12;)
                {
                  ...
                  if (i == 1)
                  {
                    ...
                    leds.setRGB(j-20, 0, 75, 0);
                    leds.setRGB(j-21, 0, 75, 0);
                    leds.setRGB(j-22, 0, 75, 0);
                    leds.setRGB(j-23, 0, 75, 0);
                    
                   /*leds.setHSV(k, 22, 1, .1);
                    leds.setHSV(k+1, 22, 1, .1);
                    leds.setHSV(k+2, 22, 1, .1);
                    leds.setHSV(k+3, 22, 1, .1);

                    leds.setHSV(k+10, 22, 1, .1);
                    leds.setHSV(k+11, 22, 1, .1);
                    leds.setHSV(k+12, 22, 1, .1);
                    leds.setHSV(k+13, 22, 1, .1);*/
                    
                    leds.setRGB(k+20, 0, 75, 0);
                    leds.setRGB(k+21, 0, 75, 0);
                    leds.setRGB(k+22, 0, 75, 0);
                    leds.setRGB(k+23, 0, 75, 0);
                  ...
                  if (i > 1)
                  {
                    ...
                    /*leds.setRGB(k-4, 0, 0, 0);
					leds.setRGB((k+10)-4, 0, 0, 0);*/
                    leds.setRGB((k + 20)-4, 0, 0, 0);
                    //leds.setRGB(l-4, 0, 0, 0);
                  }
                   ...
                   if (i == 12)
                  {
                   ...
                   /* leds.setRGB(k, 0, 0, 0);
                    ...
                    leds.setRGB(k+10, 0, 0, 0);
                    leds.setRGB((k+10)-1, 0, 0, 0);
                    leds.setRGB((k+10)-2, 0, 0, 0);
                    leds.setRGB((k+10)-3, 0, 0, 0);*/
                    
                    leds.setRGB(k + 20, 0, 0, 0);
                    leds.setRGB((k + 20) -1, 0, 0, 0);
                    leds.setRGB((k + 20)-2, 0, 0, 0);
                    leds.setRGB((k + 20)-3, 0, 0, 0);
